...
//CODE HERE
  let phone1 = new Phone('apple', 'iphone 12', 256, 'black', false)

  let phone2 = new Phone('samsung', 'galexy fold', 512, 'silver', false)
  
  let phone3 = new Phone('nokia', '3310', 1, 'gray', false)
